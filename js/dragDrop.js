...
/**
 * Function is called by the moveTouching() function to allow for a dymanic scroll during the drag-drop on mobile devices
 * It calculates the top and bottom 60 pixels. When a touch is registered in the defined areas an interval is called that scrolls up or down.
...
function checkAutoScroll(event) {
    ...
    let topLimit = rect.top + 40;
    let bottomLimit = rect.bottom - 40;
